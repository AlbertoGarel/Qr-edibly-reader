...
module.exports = {
  ...
  // moduleNameMapper: require('jest-module-name-mapper')('/jest.config.ts'),
  ...
  // ],
  transformIgnorePatterns: [
    "node_modules/(?!((jest-)?react-native|@react-native(-community)?)|expo(nent)?|@expo(nent)?/.*|@expo-google-fonts/.*|react-navigation|@react-navigation/.*|@unimodules/.*|unimodules|sentry-expo|native-base|react-native-svg|expo-localization|i18n-js|react-redux|redux-persist)"
  ...
  moduleNameMapper: {
    "expo-localization": "<rootDir>/node_modules/expo-localization/",
  },
}
...
//   // cacheDirectory: "C:\\Users\\qmeli\\AppData\\Local\\Temp\\jest",
//

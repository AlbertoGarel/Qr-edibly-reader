...
export enum FAVOURITE_LIST_ACTION_TYPES {
  ...
  UPDATE_ITEM = "FAVOURITE/UPDATE_ITEM"
}
...
export const updateCustomNameFavourite = (id: number[], name: string): { type: FAVOURITE_LIST_ACTION_TYPES.UPDATE_ITEM; params: { id: number[], name: string } } => ({
  type: FAVOURITE_LIST_ACTION_TYPES.UPDATE_ITEM,
  params: {id, name}
})